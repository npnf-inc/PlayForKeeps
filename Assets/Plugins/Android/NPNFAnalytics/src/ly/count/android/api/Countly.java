...
public class Countly {
    ...
    public void setConnectionQueueUserId(String userId)
    {
        queue_.setSkieUserId(userId);
    }

    public void init(Context context, String serverURL, String appKey, String clientId, String accessToken) {
        ...
        queue_.setAppKey(appKey);
				queue_.setClientId(clientId);
				queue_.setAccessToken(accessToken);
	...
	public void recordEvent(String key, String segmentation, int count) {
		Gson gson = new Gson();
		Map<String, String> map = new HashMap<String, String>();
		map = (Map<String, String>) gson.fromJson(segmentation, map.getClass());
		recordEvent(key, map, count);
    }

    // From JNI
    @SuppressWarnings("unchecked")
	public void recordEvent(String key, String segmentation, int count, double sum) {
		Gson gson = new Gson();
		Map<String, String> map = new HashMap<String, String>();
		map = (Map<String, String>) gson.fromJson(segmentation, map.getClass());
		recordEvent(key, map, count, sum);
    }
...
class ConnectionQueue {
    ...
    private String skieClientId_;
    private String skieUserId_ = "undefined";
		private String currentSessionId_;
    ...
    public void setSkieUserId(String userId){
        skieUserId_ = userId;
    }

    public void beginSession() {
        currentSessionId_ = UUID.randomUUID().toString();
				Log.d(TAG, "New session ID = " + currentSessionId_);
        String data;
        data = "app_key=" + appKey_;
        data += "&" + "skie_client_id=" + skieClientId_;
        data += "&" + "skie_user_id=" + skieUserId_;
				data += "&" + "skie_session_id=" + currentSessionId_;
                ...
                while (true) {
                    ...
                    try {
                        ...
                        HttpGet method = new HttpGet(new URI(serverURL_ + "/i?" + data));
												method.addHeader("access_token", accessToken_);
