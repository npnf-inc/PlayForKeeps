    ...
    public class NPNFAssetsEditor : EditorWindow
    {
        ...
        private void ResizeAndFitRectOnScreen(Rect rectCurrent)
        {
            ...
            if (isDockedMethod == null || !(bool)isDockedMethod.Invoke(this, null))
            {
                ...
                rect.width = 5 * CELL_WIDTH + 2 * MARGIN;
                rect.height = rectCurrent.y + MARGIN;
        ...
        private void OnGUI()
        {
            ...
            } else if (mTypesLoaded)
            {
                ...
                } else
                {
                    ...
                    {
                        EditorGUI.LabelField(mRect, "Assets", mSelectionLabelStyle);
                        mRect.x = MARGIN;
        ...
        private void CollectionsGUI()
        {
            ...
            if (mTypesLoaded)
            {
				...
				{
					selected = GUI.SelectionGrid(mRect, mSelectedTypeIndex, assetTypesContent, maxRowCellCount);
				}
