...
namespace NPNF
{
    public partial class UnityBridgeIOSPlugin
    {
        ...
        public void GetContactAccessPermissionStatus()
        {
            ...
            NPNF.NPNFBridge.Instance.ReceiveMessage("OnGetPermissionStatus", args);
        }
        ...
        public void GetAddressBookPhoneList()
        {
            ...
            object[] args = new object[1];
            args[0] = phoneNumbers;
            NPNF.NPNFBridge.Instance.ReceiveMessage("OnAskPermissionResponsed", args);
        }
        ...
        public void OnSynchronizeContactsComplete(string contacts)
        {
            object[] args = new object[1];
            args[0] = contacts;
            NPNF.NPNFBridge.Instance.ReceiveMessage("OnSynchronizeContactsComplete", args);
        }
        ...
        public void OnLoadFriendsFromAddressBookComplete(string response)
        {
            object[] args = new object[1];
            args[0] = response;
            NPNF.NPNFBridge.Instance.ReceiveMessage("OnLoadFriendsFromAddressBookComplete", args);
        }
    }
}
#endif